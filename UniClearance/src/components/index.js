...
export {default as RecentClearedComponent} from './recentCleared';
...
export {default as ResetPasswordValidationSchema} from './validationSchema/ResetPasswordValidationSchema';
